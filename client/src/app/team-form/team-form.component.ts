...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, forwardRef(() => SteperComponent),FitxesJugadorsComponent, CdkStepperModule, DadesGeneralsComponent, DadesJugadorsComponent, DadesEntrenadorsComponent, PrevisualitzacioComponent],
})
